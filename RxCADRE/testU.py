...
wrfdata = '/Users/nmoisseeva/data/plume/RxCADRE/Feb2019/wrfout_L2G'
...
wrf_U = np.sqrt(nc_data.variables['U'][:,:,CSUidx[0],CSUidx[1]]**2 + nc_data.variables['V'][:,:,CSUidx[0],CSUidx[1]]**2)
z = np.mean((nc_data.variables['PHB'][:,:,CSUidx[0],CSUidx[1]] + nc_data.variables['PH'][:,:,CSUidx[0],CSUidx[1]]) / 9.81,0)
