...
plt.hlines(rxzCL,xmin=0, xmax = 3000, label='LES injection height $z_{CL}$ = %.f m' %rxzCL)
# plt.hlines(LESsolution,xmin=0, xmax = 3000,linestyle=':', colors='C2', label='modelled injection height (LES heat) $z_{CL}$ = %.f m' %LESsolution)
plt.hlines(LESRAWsolution,xmin=0, xmax = 3000,linestyle='--', colors='C3', label='modelled injection height $z_{CL}$ = %.f m' %LESRAWsolution)
